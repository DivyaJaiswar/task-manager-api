...
* Developed a RESTful API using TypeScript for improved code reliability
* Designed and implemented database schema using SQL
* Documented API endpoints using OpenAPI for easier testing and integration
...
Divya Jaiswar
GitHub: https://github.com/DivyaJaiswar
